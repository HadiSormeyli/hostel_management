  ...
  void initState() {
    ...
    widget.validation.validatePersonalInfo = () {
      ...
      _religionKey.currentState!.validate()) {
        addStudent['NationalCode'] = codeController.value.text;
        addStudent['Name'] = fnameController.value.text;
        addStudent['LastName'] = lnameController.value.text;
        addStudent['IdNumber'] = nationalNumberController.value.text;
        addStudent['IdentitySerialNumber'] = seriNumberController.value.text;
        addStudent['Nationality'] = nationalityController.value.text;
        addStudent['Religion'] = religionController.value.text;
        addStudent['Gilder'] = faithController.value.text;
        addStudent['CellularPhone'] = mobileNumberController.value.text;
        addStudent['MothersPhone'] = motherNumberController.value.text;
        addStudent['FathersPhone'] = fatherNumberController.value.text;
        addStudent['EmailAddress'] = emailController.value.text;
        addStudent['FathersName'] = fatherNameController.value.text;
        addStudent['MothersName'] = motherNameController.value.text;
        addStudent['BirthPlace'] = birthPlaceController.value.text;
        addStudent['BirthCertificateIssuingPlace'] =
            sodoorPlaceController.value.text;

        addStudent['DateOfBirth'] = label;

        addStudent['PostalCode'] = postCodeController.value.text;
        addStudent['Address'] = addressController.value.text;
        addStudent['State'] = stateController.value.text;
        addStudent['City'] = cityController.value.text;
        return true;
      }
      addStudent['PostalCode'] = postCodeController.value.text;
      addStudent['Address'] = addressController.value.text;
                              ...
                              GestureDetector(
                                onTap: () async {
                                  ...
                                  if (picked != null &&
                                    ...
                                    setState(() {
                                      label =
                                      "${picked.year}/${picked.month.toString()
                                          .padLeft(2, '0')}/${picked.day
